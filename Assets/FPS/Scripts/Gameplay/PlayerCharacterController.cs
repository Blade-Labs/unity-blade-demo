...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        async void Start()
        {
            ...
            // BladeSDK bladeSdk = new BladeSDK("ygUgCzRrsvhWmb3dsLcDpGnJpSZ4tk8hACmZqg9WngpuQYKdnD5m8FjfPV3XVUeB", BladeLabs.UnitySDK.Network.Testnet, "unitysdktest", SdkEnvironment.CI, "http://localhost:8443");
